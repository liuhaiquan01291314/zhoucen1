package com.example.zhoucen1.db;
...
public class DatasBeanDao extends AbstractDao<DatasBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ChapterId = new Property(4, Long.class, "chapterId", false, "CHAPTER_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DATAS_BEAN\" (" + //
                ...
                "\"CHAPTER_ID\" INTEGER," + // 4: chapterId
    ...
    public DatasBean readEntity(Cursor cursor, int offset) {
        DatasBean entity = new DatasBean( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4), // chapterId
    ...
    public void readEntity(Cursor cursor, DatasBean entity, int offset) {
        ...
        entity.setChapterId(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
